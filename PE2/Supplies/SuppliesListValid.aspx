<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuppliesListValid.aspx.cs" Inherits="PE2.Supplies.SuppliesListValid" %>
...
<body>
    ...
    <div style="text-align: left">
        &nbsp;
        <%--    <input id="btnAdd" runat="server" type="button" value="耗材新增" class="enjoy-css" Visible="false"  onclick="OpenAdd()" />--%>
        <%--    <input id="btnSearch" type="button" value="查詢" class="enjoy-css" onclick="OpenDialog()" />--%>
        &nbsp;<asp:Button ID="btnExport" CssClass="enjoy-css" runat="server" Text="匯出" Visible="false" />
    ...
    <asp:GridView ID="gvList" runat="server" CellPadding="3" CssClass="EU_DataTable"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Supplies_Price" HeaderText="耗材價格">
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
            </asp:BoundField>
