<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShieldingBoxCp.aspx.cs"
    Inherits="PE2.Assets.ShieldingBoxCp" %>
                                ...
                                <td width="400">
                                    <label for="question">
                                        標籤代碼:</label>&nbsp;<asp:TextBox ID="txtAsset_no" runat="server" Width="100" AutoPostBack="True"
                                            OnTextChanged="txtAsset_no_TextChanged" Enabled="False"></asp:TextBox>
                                </td>
                                <td>
                                    <label for="question">
                                        資產管制名稱:</label>
                        ...
                        <table>
                            <tr>
                                <td width="400">
                                    <label for="question">
                                        校驗時間:</label>
                                    <asp:TextBox ID="txtCp_date" runat="server"  CssClass="calendar" Width="100"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
