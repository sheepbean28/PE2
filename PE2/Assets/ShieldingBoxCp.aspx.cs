...
{
    public partial class ShieldingBoxCp : System.Web.UI.Page
    {
        ...
        public void LoadData() 
        {
            ...
            txt2GOpen.Text = modShieldingBox.Cp2G_Open.ToString() == string.Empty ? "0" : modShieldingBox.Cp2G_Open.ToString();
            txt2GClose.Text = modShieldingBox.Cp2G_Close.ToString() == string.Empty ? "0" : modShieldingBox.Cp2G_Close.ToString();
            txt2GShild.Text = modShieldingBox.Cp2G_Shileld.ToString() == string.Empty ? "0" : modShieldingBox.Cp2G_Shileld.ToString();
            txt5GOpen.Text = modShieldingBox.Cp5G_Open.ToString() == string.Empty ? "0" : modShieldingBox.Cp5G_Open.ToString();
            txt5GClose.Text = modShieldingBox.Cp5G_Close.ToString() == string.Empty ? "0" : modShieldingBox.Cp5G_Close.ToString();
            txt5GShild.Text = modShieldingBox.Cp5G_Shileld.ToString() == string.Empty ? "0" : modShieldingBox.Cp5G_Shileld.ToString();
            txtCp_date.Text = DateTime.Now.ToString("yyyy-MM-dd");
