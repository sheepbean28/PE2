<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalibrateReturn.aspx.cs" Inherits="PE2.Assets.ReturnCalibrate" %>
        ...
        <ContentTemplate>
            <div>
                <fieldset>
                    <legend>儀器校驗</legend>
                    <p>
                        儀器送回<asp:HiddenField ID="hfCalibrate_sn" runat="server" />
                    </p>
                    <div class="elements">
                        <table>
                            <tr>
                                <td width="500">
                                    <label for="question">
                                        校驗日期:</label>&nbsp;
                                    <asp:TextBox ID="tbStartEate" runat="server" required CssClass="calendar"  autocomplete="off" ></asp:TextBox>
                                </td>
                                <td>
                                </td>
                            </tr>
