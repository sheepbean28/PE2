...
(function ($)
{
    ...
    $.ligerDefaults.ComboBox = {
        ...
        detailUrl: null,            //確定选项的时候，使用这个detailUrl加载到详细的数据
        ...
        */
        ...
        showFilter: function ()
        {
            ...
            return g.winfilter = $.ligerDialog.open({
                ...
                buttons: [
					{ text: '確定', onclick: function (item, dialog) { loadData(); dialog.hide(); } },
...
(function ($)
{
    ...
    $.ligerMessageBox.alert = function (title, content, type, onBtnClick)
    {
        ...
        p = {
            title: title,
            content: content,
            buttons: [{ text: '確定', onclick: onclick}]
        };
        if (type) p.type = type;
        return $.ligerMessageBox(p);
    };
...
(function ($)
{
    ...
    $.ligerDefaults.TabString = {
        closeMessage: "關閉當前頁",
        closeOtherMessage: "關閉其他",
        closeAllMessage: "關閉所有",
        reloadMessage: "更新"
    };
