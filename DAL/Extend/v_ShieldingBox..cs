...
namespace PE2.DAL
{
    public partial class v_ShieldingBox
    {
        public DataTable GetShieldingBoxList(Model.v_ShieldingBox model)
        {
            ...
            strSql.Append(" Select * from [v_ShieldingBox] WHERE 1 = 1 ");
            ...
            {
                strSql.Append(" And Cp_date  >= '" + model.Last_Cp_Date_s + "'");

            }
            if (model.Last_Cp_Date_d != string.Empty && model.Last_Cp_Date_d != null)
            {
                strSql.Append(" And Cp_date  <= '" + model.Last_Cp_Date_d + "'");

            }
            if (model.Next_Cp_Date_s != string.Empty && model.Next_Cp_Date_s != null)
            {
                strSql.Append(" And Limit_date  >= '" + model.Next_Cp_Date_s + "'");

            }
            if (model.Next_Cp_Date_d != string.Empty && model.Next_Cp_Date_d != null)
            {
                strSql.Append(" And Limit_date  <= '" + model.Next_Cp_Date_d + "'");

            }
            strSql.Append(" order by Limit_date  ");
